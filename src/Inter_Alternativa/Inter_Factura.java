 ...
 * @author kaien
 */
public class Inter_Factura extends javax.swing.JFrame {

    public AccesoSQL acceso;
    
    public Inter_Factura() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inter_Factura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
