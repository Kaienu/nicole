 ...
 * @author kaien
 */
public class Inter_Add_Cliente extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inter_Add_Cliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
