...
public class DetalleFactura extends javax.swing.JDialog {
     ...
     */
    public DetalleFactura(java.awt.Frame parent, boolean modal, Factura factura, AccesoSQL con) {
        super(parent, modal);
        acceso = con;
        factu = factura;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DetalleFactura dialog = new DetalleFactura(new javax.swing.JFrame(), true, factu, acceso);
