    ...
    public Font fuenteRoboto(float size,int type,int style) {
        ...
        try {
            ...
            switch (style) {
                ...
                case 1:
                    Font fuente1 = Font.createFont(Font.TRUETYPE_FONT, getClass().getResourceAsStream("/recursos/Roboto-Bold.ttf"));
                    return fuente1.deriveFont(type, size);
                case 2:
                    Font fuente2 = Font.createFont(Font.TRUETYPE_FONT, getClass().getResourceAsStream("/recursos/Roboto-Light.ttf"));
